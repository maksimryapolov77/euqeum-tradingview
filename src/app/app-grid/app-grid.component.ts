...
export class AppGridComponent implements OnInit {
  ...
  columnDefs = [
    ...
    { headerName: 'Original Name', field: 'v.original_name', sortable: true, filter: true },
    { headerName: 'Lp', field: 'v.lp', sortable: true, filter: true },
    { headerName: 'Ask', field: 'v.ask', sortable: true, filter: true },
    { headerName: 'Bid', field: 'v.bid', sortable: true, filter: true },
    { headerName: 'Open Price', field: 'v.open_price', sortable: true, filter: true },
    { headerName: 'High Price', field: 'v.high_price', sortable: true, filter: true },
    { headerName: 'Low Price', field: 'v.low_price', sortable: true, filter: true },
    { headerName: 'Prev Close Price', field: 'v.prev_close_price', sortable: true, filter: true },
    { headerName: 'Volume', field: 'v.volume', sortable: true, filter: true },
  ];
